    ...
    <div className="mx-auto max-w-7xl px-4 py-12 w-full mt-20">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    <a href="tel:+254769567516" className="hover:text-primary">
                      +254 769 567 516
                    </a>
                  </p>
                </div>
      ...
      <div className="mt-16">
        <div className="aspect-[16/9] w-full overflow-hidden rounded-lg border">
          <iframe
            src="https://maps.google.com/maps?q=Stowburg,+Eldoret,+Kenya&t=&z=15&ie=UTF8&iwloc=&output=embed"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen=""
            loading="lazy"
            title="Luxe Nest Location"
          ></iframe>
        </div>
      </div>
    </div>
