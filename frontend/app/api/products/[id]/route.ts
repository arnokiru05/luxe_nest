...
const MOCK_PRODUCTS = [
  ...
  { id: "wall-clock", name: "Premium Wall Clock", price: 4200, image: "/featured/blender.png", category: { id: "cat-decor", name: "Decor", slug: "decor" }, description: "Sleek minimal wall clock with a matte finish, perfect for any modern interior.", inStock: false, rating: 4.0, featured: false, createdAt: new Date().toISOString() },
