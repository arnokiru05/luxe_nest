...
import { ChevronRight, Minus, Plus, ShoppingCart, Star, Truck, Shield, RotateCcw, Heart } from "lucide-react"
        ...
        >
          ...
          <div className="mt-8 flex items-center gap-3">
            ...
            <Button
              ...
              size="icon"
              variant="outline"
              className="h-12 w-12 rounded-full border-slate-200 text-slate-800 bg-white hover:bg-slate-50 transition-all hover:scale-105 active:scale-95 shadow-sm shrink-0 flex items-center justify-center"
              title={inWish ? "Remove from Wishlist" : "Save to Wishlist"}
            >
              <Heart className={`h-5 w-5 transition-colors ${inWish ? "fill-rose-500 text-rose-500" : "text-slate-700"}`} />
            </Button>
          </div>
