            ...
            <div className="space-y-2">
              ...
              {categories.length > 0 ? (
                ...
                <div className="rounded-md border border-amber-200 bg-amber-50 p-3 text-sm text-amber-800 dark:border-amber-800 dark:bg-amber-950 dark:text-amber-300">
                  No categories found. Please <Link href="/admin/categories/new" className="underline hover:text-amber-600 dark:hover:text-amber-200">create a category</Link> first.
                </div>
              )}
